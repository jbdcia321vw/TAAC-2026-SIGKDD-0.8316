...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--train_ratio', type=float, default=1.0,#这里是去掉valid ratio部分的的数据后的train_ratio
...
def main() -> None:
    ...
    if args.seq_max_lens:
        #format eg:'seq_a:256,seq_b:256,seq_c:512,seq_d:512'
    ...
    model_args = {
        "user_int_feature_specs": user_int_feature_specs,#[(vocab_size, offset, length), ...]
        "item_int_feature_specs": item_int_feature_specs,
        "user_dense_dim": pcvr_dataset.user_dense_nonaligned_dim,
        "item_dense_dim": pcvr_dataset.item_dense_schema.total_dim,
        "seq_vocab_sizes": pcvr_dataset.seq_domain_vocab_sizes,#w/o timestamp
        ...
        "user_aligned_plan": pcvr_dataset.user_aligned_plan,
    }

    logging.info(f"user_dense_dim={model_args['user_dense_dim']}, "
                 f"user_dense_nonaligned_dim={pcvr_dataset.user_dense_nonaligned_dim}, "
                 f"user_dense_schema_total={pcvr_dataset.user_dense_schema.total_dim}")
